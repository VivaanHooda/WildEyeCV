#!/usr/bin/env python3
"""
Mac-optimized Animal Detection System Runner - Simplified Version
Uses your trained model directly without unnecessary file searching
"""
...
class MacAnimalDetectionRunner:
    ...
    def load_model(self):
        ...
        if not os.path.exists(self.model_path):
            ...
            print("Make sure 'best_model.pth' is in the current directory")
            return False
    ...
    def start_server(self):
        ...
        if not os.path.exists(server_script):
            ...
            print("Skipping API server - will run webcam detection only")
            return False
            ...
            try:
                ...
                for box, score, label in zip(boxes, scores, labels):
                    if label < len(self.detector.class_names):
                        ...
                        # Send to API (with cooldown) if server is running
                        ...
                        if (current_time - last_detection_time) > detection_cooldown:
                            if save_detections:
                                ...
                                # Send to API if server is running
    ...
    def run_complete_system(self):
        ...
        # Step 2: Load model first (most important)
        ...
        # Step 4: Try to start API server (optional)
        server_started = self.start_server()
        if not server_started:
            print("Continuing with webcam detection only...")
...
def main():
    ...
    print("1. Run complete system (webcam + optional API)")
